...
function ImageCardDetails() {
  ...
  return (
    <>
    <div className='bg-blue-900 text-white py-10 px-2 lg:p-10'>
      <Link to="/" className="text-2xl float-left my-4 text-red-500 hover:underline">
        Home
      </Link>
      {Object.keys(photo).length > 0 && (
        <div>
          <h1 className='text-center my-6 mt-20 sm:my-14 text-3xl md:text-5xl'>Details Page</h1>
    ...
    <div className='my-20'>
      <h1 className='my-14 text-center text-5xl'>Related Images</h1>
    <ImageCard/>
    </div>
    </>
  );
